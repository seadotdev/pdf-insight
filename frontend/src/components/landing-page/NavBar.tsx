...
import { DocumentExplorer } from "~/components/content-section/DocumentExplorer";
import { Conversation } from "~/components/conversations/Conversation";
import { KnowledgeGraph } from "~/components/content-section/KnowledgeGraph";
import { ContentElement } from "~/components/content-section/ContentElement";
import Flow from "~/components/content-section/Flow";
    ...
    return (
        <Flowbite theme={{ theme: customTheme }}>
            <Sidebar aria-label="Nav Menu">
                ...
                <Sidebar.Items>
                    <Sidebar.ItemGroup >
                        <Sidebar.Item href="/knowledgegraph/asd" icon={HiHome}>Home</Sidebar.Item>
                        <Sidebar.Collapse icon={HiViewBoards} label="Lending Workflows">
                            <Sidebar.Item href="utools" icon={HiNewspaper} onClick={() => { setActiveItem("Underwriting Tools"); }} className="pl-4">Underwriting Tools</Sidebar.Item>
