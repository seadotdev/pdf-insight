...
export const DocumentExplorer = () => {
    ...
    return (
        <div className="w-full flex grow flex-col max-w-[800px] m-4 p-4 items-center border-gray-500 rounded border">
            <div className="divide-y divide-gray-100 md:divide-y-8">    
            <span className="font-extrabold">Document Templates</span>
            ...
            <span className="font-extrabold">Upload and convert to Template</span>
