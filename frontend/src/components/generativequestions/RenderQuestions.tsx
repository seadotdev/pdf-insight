            ...
            {isOpen && (
                <>
                    <div className="ml-4 border-l border-l-gray-30 pb-1 pl-4 font-nunito text-[11px] font-light text-gray-60">
                        <div>User Response Received</div>
                                                        ...
                                                        <div className=" mr-2 flex w-full overflow-x-scroll pl-2 ">
                                                            {subQuestion.citations?.map(
                                                                (citation, citationIndex) => {
                                                                    ...
                                                                    const yearDisplay = citationDocument.year;
                                                                    return (
                                                                        <CitationDisplay
                ...
                <div className="flex h-full items-center justify-center ">
                    <div className="flex w-full flex-col items-center justify-center">
                        ...
                        <div className="mb-2 w-3/4 text-center text-lg font-bold">
                            Please tell us about your business and why you need a loan. Please also make references to the documents you&apos;ve
                            uploaded, including details such as:
                        </div>
                        <div className="m-auto flex w-full flex-wrap justify-center">
                            ...
                            <button
                                ...
                                className="m-1 flex-shrink rounded-full border border-gray-60 px-3 py-1 hover:bg-gray-15"
                            >
                                Who are the shareholders of the business, how long have they owned the business and what is their long term plan?
                            </button>
                            <button
                                onClick={() =>
                                    setUserMessage("What are the biggest discussed risks?")
                                ...
                                className="m-1 flex-shrink rounded-full border border-gray-60 px-3 py-1 hover:bg-gray-15"
                            >
                                What is the purpose of the loan, has the business considered other forms of financing?
                            </button>
                        </div>
                    </div>
                </div>
